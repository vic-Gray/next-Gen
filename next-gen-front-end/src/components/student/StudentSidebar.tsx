...
export function StudentSidebar() {
  ...
  const menuItems = [
    { href: `/school/${subdomain}/student/dashboard`, label: 'Dashboard', icon: Home },
    { href: `/school/${subdomain}/student/dashboard/classes`, label: 'My Classes', icon: BookOpen },
    { href: `/school/${subdomain}/student/dashboard/results`, label: 'Results', icon: BarChart3 },
    { href: `/school/${subdomain}/student/dashboard/attendance`, label: 'Attendance', icon: UserCheck },
    { href: `/school/${subdomain}/student/dashboard/profile`, label: 'Profile', icon: User },
  ];
