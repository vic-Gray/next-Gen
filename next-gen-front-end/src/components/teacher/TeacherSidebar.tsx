...
export function TeacherSidebar() {
  ...
  const menuItems = [
    { href: `/school/${subdomain}/teacher/dashboard`, label: 'Dashboard', icon: Home },
    { href: `/school/${subdomain}/teacher/dashboard/classes`, label: 'My Classes', icon: BookOpen },
    { href: `/school/${subdomain}/teacher/dashboard/attendance`, label: 'Attendance', icon: UserCheck },
    { href: `/school/${subdomain}/teacher/dashboard/students`, label: 'Students', icon: Users },
    { href: `/school/${subdomain}/teacher/dashboard/profile`, label: 'Profile', icon: User },
  ];
